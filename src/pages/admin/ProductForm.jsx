...
import { ArrowLeft, Save, ImagePlus, CheckCircle2 } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[rgba(244,211,94,0.2)] bg-[#141414] py-12 transition hover:bg-[rgba(244,211,94,0.02)] cursor-pointer">
                <ImagePlus className="mb-3 h-8 w-8 text-[#C9AA4A]" />
                <p className="text-sm font-medium text-[#F5F2EA]">Klik untuk unggah foto</p>
      ...
      {showSuccess && createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#0a0a0a]/80 p-4 backdrop-blur-sm animate-fade-in">
          <div className="glass-panel flex w-full max-w-sm flex-col items-center rounded-[2rem] p-8 text-center border border-[rgba(244,211,94,0.08)]">
            ...
            <h3 className="text-xl font-semibold text-[#F5F2EA]">Berhasil Disimpan</h3>
            <p className="mt-2 text-sm text-soft">Data properti Anda telah berhasil disimpan ke katalog.</p>
            <button 
