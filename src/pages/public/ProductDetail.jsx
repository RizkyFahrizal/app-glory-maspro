...
export default function ProductDetail() {
  ...
  useEffect(() => {
    const fetchProductDetail = async () => {
      try {
        const response = await axios.get(`https://api.glorymaspro.biz.id/api/products/${slug}`)
  ...
  const handleContactClick = async (e) => {
    ...
    try {
      const res = await axios.get('https://api.glorymaspro.biz.id/api/wa-marketing/next')
      let waNumber = ''
