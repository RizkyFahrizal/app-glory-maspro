...
export default function Home() {
  ...
  const fetchLocations = async () => {
    try {
      const res = await axios.get('https://api.glorymaspro.biz.id/api/products/locations')
  ...
  const fetchPropertyTypes = async () => {
    try {
      const res = await axios.get('https://api.glorymaspro.biz.id/api/products/types')
      if (res.data && res.data.success) {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://api.glorymaspro.biz.id/api/products', {
        params: {
